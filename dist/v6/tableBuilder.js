...
//#endregion
//#region buildTable/forBody/cellRenderers/renderButtonControl.js
function u(e, t) {
...
//#endregion
//#region buildTable/forBody/cellRenderers/renderArrayView.js
function d(e, t) {
...
//#endregion
//#region buildTable/forBody/cellRenderers/renderDefault.js
function f(e, t) {
...
function b({ inClasses: e = {}, inCommonOptions: t = {} }) {
...
function x({ inData: e, inColumns: n, inClasses: r = {}, inFootOptions: i = {} }) {
...
function S({ inData: e, inColumns: t, inClasses: n = {}, inFootOptions: r = {} }) {
	let i = e, a = t, o = n, s = r, c = document.createElement("tfoot"), l = x({
		inData: i,
		inColumns: a,
		inClasses: o,
		inFootOptions: s
...
function C({ inData: e, inColumns: t, inClasses: n = {}, inTableOptions: r = {}, inSortState: i = [], inOnSort: a = () => {} }) {
	let o = e, s = t, l = n, u = r, d = u.inCommonOptions || {}, f = u.inHeadOptions || {}, p = u.inBodyOptions || {}, m = u.inFootOptions || {}, h = i, g = a;
	if (!o || o.length === 0) return y({ inClasses: l });
	let _ = b({
		inClasses: l,
		inCommonOptions: d
	}), x = s.filter((e) => e.isVisible !== !1), C = c({
		inColumns: x,
		inClasses: l.head || {},
		inHeadOptions: f,
		inSortState: h,
...
function j({ inData: e, inColumns: t, inShowSerialNo: n }) {
	let { data: r, columns: i } = k(e, t, n);
	return {
		processedData: r,
...
function M({ inLabel: e = "", inPlaceholder: t = "", inClasses: n = {}, inOnSearch: r = () => {} }) {
...
function N({ inTableOptions: e = {} }) {
	let t = {
		...T.inTableOptions.inCommonOptions,
		...e.inCommonOptions || {}
	}, n = {
		...T.inTableOptions.inHeadOptions,
		...e.inHeadOptions || {}
	}, r = {
		...T.inTableOptions.inBodyOptions,
		...e.inBodyOptions || {}
	}, i = {
		...T.inTableOptions.inFootOptions,
		...e.inFootOptions || {}
	};
	return {
		inCommonOptions: {
			inTableWidth: A(t.inTableWidth),
			inTableBorder: A(t.inTableBorder),
			inShowSerialNo: t.inShowSerialNo
		},
		inHeadOptions: { inHeaderHeight: A(n.inHeaderHeight) },
		inBodyOptions: { inRowHeight: A(r.inRowHeight) },
		inFootOptions: {
			inShowFooter: i.inShowFooter,
			inRowHeight: A(i.inRowHeight)
		}
	};
}
//#endregion
...
function F({ inTopHeader: e }) {
	return e === T.inTopHeader ? T.inTopHeader : {
		inShow: e.show === void 0 || e.show,
		inLabel: e.label === void 0 ? T.inTopHeader.inLabel : e.label,
		inPlaceholder: e.placeholder === void 0 ? T.inTopHeader.inPlaceholder : e.placeholder
	};
}
//#endregion
//#region buildTable/utils/config/mergeClasses.js
function I({ inClasses: e }) {
	let t = e || {};
	return {
		...w,
		...t,
...
var R = class {
	constructor({ htmlId: e, data: t, columns: n = [], classes: r = {}, tableOptions: i = {}, topHeader: a = T.inTopHeader }) {
		let o = e, s = t, c = n, l = r, u = P(i);
		this.tableOptions = N({ inTableOptions: u }), this.topHeader = F({ inTopHeader: a }), this.htmlId = o;
		let { processedData: d, processedColumns: f } = j({
			inData: s,
			inColumns: c,
			inShowSerialNo: this.tableOptions.inCommonOptions.inShowSerialNo
		});
		this.originalData = d, this.data = [...d], this.columns = f, this.classes = I({ inClasses: l }), this.sortState = [], this.tableElement = null;
	}
	handleSort(e, t = !1) {
		E(this, e, t);
	}
	...
	buildTopHeaderElement() {
		return !this.topHeader || this.topHeader.inShow === !1 ? null : M({
...
window.ks = {}, window.ks.TableBuilder = R, window.ks.TableBuilder.DEFAULT_CLASSES = w, window.ks.TableBuilder.DEFAULT_CONFIG = T, window.ks.TableBuilder.version = "v3.0";
//#endregion
export { w as DEFAULT_CLASSES, T as DEFAULT_CONFIG, R as TableBuilder };
